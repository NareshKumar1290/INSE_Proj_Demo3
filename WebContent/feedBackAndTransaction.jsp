...
<%
	ArrayList<TaskDetailBean> taskDetailDaoObj = TaskDetailDao.fetchClientTaskRecords(request.getParameter("loginId"), request.getParameter("taskId"), "Completed");
  ...
  <body bgcolor="white">
    ...
    <tr>
      ...
      <c:forEach items="${taskDetailDao}" var="taskDetailDao">
        <tr>
          <td onClick="openPage('feedBackAndTransactionSubmission.jsp?taskId=<c:out value="${taskDetailDao.taskId}" />');" headers="taskName"><c:out value="${taskDetailDao.taskName}" /><td>	
