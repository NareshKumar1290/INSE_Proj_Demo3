...
public class RegisterDao {
	public static boolean validate(RegisterBean bean){
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("insert into login_info(firstName, email, password) values ('" + bean.getLastName() +"', '" + bean.getEmailAddress() +"', '" + bean.getPassword() +"');");
